...
<!-- ページコンテンツ -->
<div class="page-lesson page-lesson-layout">
  <div class="page-lesson__body">
    <div class="page-lesson__inner inner">
      
      <!-- カテゴリーボタン -->
      <?php if (!have_posts()): ?>
        <p class="page-lesson__no-post no-post">
          ただいま準備中です。<br>掲載までしばらくお待ちください。
        </p>

      <?php else: ?>
        <div class="page-lesson__category-buttons category-buttons" id="category-top">
          <a
        ...
        <!-- lessonカード -->
        <div class="page-lesson__cards lesson-cards">
        ...
        <!-- ページネーション -->
        <nav class="page-lesson__pagination pagination">
          <?php wp_pagenavi(); ?>
        </nav>
